...
<div class="container">
    <div class="row ">
        ...
        <div class="col-9 pt-5">
            ...
            <div class="d-flex">
                <div class="pr-5"><strong>594</strong> posts</div>
                <div class="pr-5"><strong>152k</strong> followers </div>
                <div class="pr-5"><strong>412</strong> following</div>
            </div>
            ...
            <div><a href="www.freecodecamp.com">www.freecodecamp.com </div>
        </div>
    </div>

    <div class="row pt-5">
        <div class="col-4">
            <img src="https://yt3.googleusercontent.com/ytc/APkrFKaqca-xQcJtp1Pqv-APucCa0nToHYGPVT00YBGOSw=s900-c-k-c0x00ffffff-no-rj" class="w-100">
        </div>
        <div class="col-4">
        <img src="https://yt3.googleusercontent.com/ytc/APkrFKaqca-xQcJtp1Pqv-APucCa0nToHYGPVT00YBGOSw=s900-c-k-c0x00ffffff-no-rj" class="w-100">
        </div>
